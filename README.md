...
- React, Next.js, React Native, NodeJS,FireBase,Expo
- tailwindcss
...
- **2023**
    ...
    [제 1회 나의 꿈 발표 대회 장려](https://www.notion.so/1-9148cef637f74595b30a51265b40b731?pvs=21)
    
- **2024**
    
    [제 1회 코드코리아 2024 금정구 해커톤 대상](https://www.notion.so/1-2024-81e2e1117a3642fb949e185aa994e312?pvs=21)
    
    [블록체인 ESG 해커톤 최우수상 한국인터넷진흥원장상](https://www.notion.so/ESG-f16d2073461f42d8bca169d44e00e431?pvs=21)
...
- K-Lingo 크로스 플랫폼 어플리케이션 제작
- PHP 홈페이지 유지 보수
- HTML5 기반 광고 게임 제작
- 학습 도움용 어플리케이션 MVP 제작
...
- HTML,JQuery
- 부산대학교 정보컴퓨터공학부 1학년 인터넷웹기초 수업 텀프로젝트
...
- 아두이노로 각종 센서들과 연동하여 어플로 제공
- 부산대학교 정보컴퓨터공학부 1학년 어드벤처디자인 수업 텀프로젝트
...
- ReactNative,NestJS,AI
    
    [제 9회 부산 ICT 융합 해카톤 발표자료](https://www.notion.so/9-ICT-f04e70076c8849899d6f7c973e4594f0?pvs=21)
...
- ReactNative,Firebase
- https://github.com/zune2222/GongByeol/releases/tag/v1.0.0

### 부산대학교 정보의생명공학대학 학생회 웹 페이지
...
- NextJS,FireBase
- https://github.com/zune2222/PNU-IBE/releases/tag/v1.0.0
...
- NextJS
- https://github.com/zune2222/alistouchfront
